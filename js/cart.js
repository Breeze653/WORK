...
$(function () {
            ...
            <div class="panel-footer">
                <div class="row buyInfo">
                    ...
                    <p class="col-sm-4 operate">
                        ...
                        <button class="btn btn-primary continue">继续购物</button>
                    </p>
                </div>
            </div>
        `
    ...
    $('.content .panel').on('click', '.select_item', function () {
        // 拿到元素身上记录的 id 
        // 获取元素上的 data- 开头的自定义属性
        // <div hello="world" data-a="100" data-b="200"></div>
        // 元素.dataset === { a: '100', b: '200' }
    ...
    // 4-7. 继续购物
    $('.content .panel').on('click', '.continue', function () {
        // 跳转回 列表页
